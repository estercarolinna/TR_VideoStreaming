...
public class homeList extends ListActivity {
    ...
    private static String url = "http://archive.org/advancedsearch.php?q=classic%20video&fl[]=description&fl[]=downloads&fl[]=identifier&fl[]=mediatype&fl[]=title&sort[]=&sort[]=&sort[]=&rows=50&page=1&indent=yes&output=json";
...
//                        Toast.LENGTH_SHORT).show();
                Intent in = new Intent(getApplicationContext(), VideoStreaming2.class);
            ...
            if (jsonStr != null) {
                try {
                    ...
                    for (int i = 0; i < videos.length(); i++) {
                        ...
                        String title = "Unknown", duration = "Unknown", identifier = "Unknown";
